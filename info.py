...
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002558034296').split(','))))
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/NarutoSeriesUpdates/12')
...
GRP_LNK = environ.get('GRP_LNK', '-4709762870')
CHNL_LNK = environ.get('CHNL_LNK', '-1002558034296')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002599309626))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002599309626)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002635244633)) # movies request channel, else log channel
